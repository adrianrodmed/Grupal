			...
			<c:forEach items="${miCarrito.lineaCarrito}" var="lineaCarritoInfo">
				<div class="product-preview-container">
					<ul>
						...
						<li>Nº de Plazas: <fmt:formatNumber value="${lineaCarritoInfo.destinoInfo.numplazas}"/></li>
						<li>Precio: <span class="price"><fmt:formatNumber value="${lineaCarritoInfo.destinoInfo.precio}" type="currency"/></span></li>
						<li>Cantidad: <span class="cantidad"><fmt:formatNumber value="${lineaCarritoInfo.cantidad}"/></span></li>
