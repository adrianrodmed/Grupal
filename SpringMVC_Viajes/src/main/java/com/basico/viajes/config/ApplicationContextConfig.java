...
import com.basico.viajes.dao.impl.CompraDAOImpl;
import com.basico.viajes.dao.impl.CuentaDAOImpl;
import com.basico.viajes.dao.impl.DestinoDAOImpl;
 
@Configuration
@ComponentScan("com.basico.viajes.*")
...
public class ApplicationContextConfig {
    ...
    @Bean(name = "cuentaDAO")
    public CuentaDAO getApplicantDAO() {
        return new CuentaDAOImpl();
        }
 
    @Bean(name = "destinoDAO")
